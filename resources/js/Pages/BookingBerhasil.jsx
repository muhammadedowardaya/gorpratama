    ...
    return (
        <>
            <div className="max-w-md">
                ...
                <p>
                    Dilakukan pada tanggal {tanggal}, selama {waktu_sewa} jam.
                    dari jam {dari_jam} sampai jam {sampai_jam} untuk tanggal{" "}
                    {untuk_tanggal}
                </p>
                {/* <div>
...
BookingBerhasil.layout = (page) => (
    <Layout children={page} title="Berhasil Booking" />
);
